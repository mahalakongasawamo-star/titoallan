...
const CONTENT = {
  ...
  hero: {
    ...
    ctaPrimary: {
      ...
      url:  'https://geo-check.upserv.ai/',  // ← replace with your actual free scan URL  
    },
    ctaSecondary: {
  ...
  //           Use 'under-construction.html?industry=Name' for pages not yet built
  // ──────────────────────────────────────────────────────────
  industries: [
    // ── 01 ──────────────────────────────────────────────────
    {
      ...
      link:    'https://smileisleorthodontics.com/',  // ← replace with actual client link when ready   
    ...
    // ── 02 ──────────────────────────────────────────────────
    {
      ...
      name:    'Law Firm',
      image:   'law-firm.png',
      link:    'under-construction.html?industry=Law+Firm',
    ...
    // ── 03 ──────────────────────────────────────────────────
    {
      ...
      link:    'under-construction.html?industry=Real+Estate+Agency',
    ...
    // ── 06 ──────────────────────────────────────────────────
    {
      ...
      link:    'under-construction.html?industry=Retail+Store',
    ...
    // ── 07 ──────────────────────────────────────────────────
    {
      ...
      link:    'under-construction.html?industry=Home+Services',
    ...
    // ── 08 ──────────────────────────────────────────────────
    {
      ...
      link:    'under-construction.html?industry=Accounting+Firm',
